...
class fin_GDN_onlytime(nn.Module):

    def __init__(self, edge_index_sets, node_num, dim=64, dim_non=0, out_layer_inter_dim=256, input_dim=10, out_layer_num=1, topk=20, config={}):

        super(fin_GDN_onlytime, self).__init__()
...
class fin_GDN_nontime(nn.Module):

    def __init__(self, edge_index_sets, node_num, dim=64, dim_non=0, out_layer_inter_dim=256, input_dim=10, out_layer_num=1, topk=20, config={}):

        super(fin_GDN_nontime, self).__init__()
        ...
        self.net = Net(input_size=dim_non)
